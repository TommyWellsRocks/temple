...
// For now using strengthlog workouts, instructions, and muscle images

export const checklistItemsList: checklistItem[] = [
	{
		id: 836,
		title: "Snatch Grip Deadlift",
		category: "Back",
		images: [
			"https://i0.wp.com/www.strengthlog.com/wp-content/uploads/2024/05/Lifting-tempo-strength-training.jpg?resize=500%2C480&ssl=1",
		],
		...
		is_time_based: false,
		is_single_arm_based: false,
		is_single_leg_based: false,
